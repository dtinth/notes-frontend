...
function createUpdateList(updates: UpdateEntry[]) {
  ...
  div.tabIndex = 0;
  div.className =
    "bg-[#252423] px-3 pt-6 pb-2 mb-4 mt-[-22px] border border-[#656463] [box-shadow:2px_2px_#00000040] prose relative";
  ...
  <table class="mt-2">
    ...
    <tbody>
      ${updates
        .map((update) => {
          return `<tr>
            <td class="align-top pr-4 w-[12ch]">${update.date}</td>
